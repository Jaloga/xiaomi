...
def buildWizard(name, type, theme=None, over=False):
	...
	if type == 'gui':
		...
		if yes:
			...
			else: todo = DIALOG.yesno(ADDONTITLE, "[COLOR %s]El Gui fix se instalo correctamente.  quieres forzar el cierre de Kodi?[/COLOR]" % COLOR2, nolabel="[B][COLOR green]Forzar cierre[/COLOR][/B]")
